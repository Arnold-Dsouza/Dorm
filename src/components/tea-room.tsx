...
import { Coffee, Calendar, Clock, XCircle, MapPin, PartyPopper, CalendarOff, BookOpen, Check, Gift, Pencil, Trash2, Image as ImageIcon } from "lucide-react";
...
export default function TeaRoom({ title = 'Tea Room' }: TeaRoomProps = {}) {
    const [dorm, setDorm] = useState<ReturnType<typeof getDormConfig> | null>(null);
    const pageId = dorm?.id === 'tabu' ? 'teaRoom' : 'teaRoom';
